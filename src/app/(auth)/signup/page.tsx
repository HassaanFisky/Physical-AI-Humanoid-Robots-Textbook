...
export default function SignupPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      // Mock signup -> straight to login/auth
      // In real app: POST to API to create user
      setLoading(true);
      ...
      <div style={{
        ...
        <div style={{
          ...
          <div style={{ textAlign: 'center' }}>
            <h1 style={{ fontSize: '24px', fontWeight: 600, color: 'var(--text-main)', marginBottom: '8px' }}>Create account</h1>
            <p style={{ color: 'var(--text-muted)', fontSize: '14px' }}>Access the Physics AI Library</p>
          </div>
